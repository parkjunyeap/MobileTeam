...
const Review = () => {
  ...
  const handleSubmit = () => {
    ...
    if (selectedDriverId) {
      // 택시 기사에게 보내는 리뷰
      apiEndpoint = "http://10.20.61.21:8000/write/driverReviews";
    } else {
      // 일반 사용자에게 보내는 리뷰
      apiEndpoint = "http://10.20.61.21:8000/write/reviews";
    }

    // axios
    //   .post("http://10.20.61.21:8000/write/reviews", reviewData) // 리뷰 데이터 보내는사람, 받는사람, 별점 , 코멘트
    //   .then((response) => {
